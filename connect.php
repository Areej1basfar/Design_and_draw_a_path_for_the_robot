...
$stmt = $conn->prepare("INSERT INTO direction (dir) VALUES (?)"); // table name, (column name), git the value from the web page
...
//echo "successfully the inserted value is: ".$button ." <br>done. ";
        }
        ?>
